...
(function () {
  ...
  function createEditionRow(resource) {
    ...
    var editionLabel = getResourceEditionLabel(resource);

    if (resource.link) {
      var editionLink = document.createElement("a");
      editionLink.href = resource.link;
      editionLink.target = "_blank";
      editionLink.rel = "noopener";
      editionLink.className = "rbmo-biblioled-edition-link";
      editionLink.textContent = editionLabel;
      row.appendChild(editionLink);
    } else {
  ...
  function createHeadRow() {
    ...
    ["Ano / Editora", "Exemplares disponíveis", "Reservas"].forEach(
      function (label) {
