/* ==========================================
   ...
   - pesquisa na API BiblioLED apenas por título;
   - confirma localmente título + autor;
   - não utiliza ISBN;
   - ignora edição e editora;
   - reúne todas as edições da mesma obra;
   - mostra o número de edições encontradas;
   - soma os empréstimos disponíveis;
   - abre a pesquisa pública filtrada por título e autor;
   - só apresenta o botão quando existe correspondência.
   ========================================== */
...
(function () {
  ...
  /*
   * Pesquisa pública da BiblioLED.
   *
   * Usa título e autor separados, para evitar os
   * resultados excessivos provocados pelo parâmetro q.
   */
  ...
  /*
   * Disponibilidade de um recurso/edição.
   */
  ...
  /*
   * Soma a disponibilidade de todas as edições
   * correspondentes à mesma obra.
   */
