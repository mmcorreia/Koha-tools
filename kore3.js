/* ==========================================================
   ...
   v. 6.0 sobre motor v4.23, authority intelligence operacional

   1. Helper Wikidata + VIAF
   2. Pesquisa por 200$b seguido de 200$a
   3. Wikidata filtrado por pessoa humana, P31 = Q5
   4. Preenchimento assistido do UNIMARC 017
   5. Parser 017 corrigido, sem duplicação por parent/child
   6. Dashboard compacta e clicável
   7. Validação estrutural da relação autoridade → bibliográfico
   8. Foco nos campos 700, 701, 702 e subcampo $9
   9. Mapa de menções contextuais em outros campos MARC
   10. Cada ocorrência bibliográfica é uma unidade de intervenção operacional
   11. Centro operacional de correção, com redução de redundâncias e triagem por ação
   12. Parser reforçado para candidatos: se o nome aparece no MARC, indica campo, subcampo e valor
   13. Wikidata/VIAF em primeiro lugar, imagem Wikidata no cartão da autoridade e painel analítico colapsável
   14. UX operacional: ligações bibliográficas, semáforo de prioridades, OPAC e MARC direto
   15. Cartão de autoridade consolidado com imagem Wikidata, dados essenciais e índice com cores
   16. Alerta de datas, campo 400, variantes de nome e matching ampliado por universo identitário
   17. Centro operacional reorganizado: resumo, 400, corrigir, rever, menções e validação explícita $9/$4
   18. v4.8: mantém o motor bibliográfico v4.7 e aplica apenas melhorias visuais controladas
   19. v4.9: integra o menu operacional redesenhado, com grupos, contadores separados e estado ativo mais claro
   20. v4.10: simplifica o menu por cor, elimina a coluna de situação, melhora ações e comparação 200$f vs. 7xx, e aplica ícones Font Awesome nas ligações
   21. v4.16: integra tradução textual dos códigos UNIMARC $4, mantendo o código entre parênteses no diagnóstico operacional
   21. v4.14: refinamento visual final, sem mexer no motor bibliográfico, redução de maiúsculas, suavização gráfica e eliminação do scroll horizontal
   21. v4.14: simplifica textos operacionais, refina design da tabela/menus/painéis e limpa rótulos técnicos do 200$f
   21. v4.11: integra o campo 400 na leitura 200$f vs. 7xx, prevendo variante existente, forma autorizada, ausência de 7xx e eventual criação de 400
   22. v4.19: mantém motor e painéis estáveis; coloca 200$f vs. 7xx em Rever; normaliza textos para 7xx; limpa leitura MARC 700/701/702
   23. v4.21: JS-only, sem alteração do motor bibliográfico; acrescenta leitura de impacto, UX editorial, menus alinhados aos KPI, larguras equilibradas, 7xx/400 em blocos e ações mais decisivas
   24. v4.22: mantém o motor bibliográfico e acrescenta leitura do campo 500 como forma relacionada, distinguindo variante 400 de relação 500
   25. v4.23: valida completude dos campos 400 e 500, incluindo datas, forma mínima e subcampo $5 nas relações 500
...
(function () {
    ...
    $(document).ready(function () {
        ...
        var CODIGOS_FUNCAO_AUTORIZADOS = {
                "000": "Indeterminada (função)",
                "005": "Actor",
                "010": "Adaptador",
                "020": "Anotador",
                "030": "Autor de arranjo musical",
                "040": "Artista",
                "050": "Responsável editorial",
                "060": "Nome associado",
                "065": "Leiloeiro",
                "070": "Autor (ou Co-Autor)",
                "072": "Autor em citações",
                "075": "Posfaciador",
                "080": "Autor da introdução (prefácio, prólogo)",
                "090": "Autor do diálogo",
                "100": "Antecedente bibliográfico",
                "110": "Encadernador",
                "120": "Responsável pela concepção da encadernação",
                "130": "Responsável pela concepção gráfica",
                "140": "Responsável pela concepção da capa e sobrecapa",
                "150": "Responsável pela concepção dos extratextos",
                "160": "Livreiro",
                "170": "Calígrafo",
                "180": "Cartógrafo",
                "190": "Censor",
                ...
                "205": "Colaborador",
                "210": "Comentador",
                "212": "Comentador (texto escrito)",
                "220": "Compilador",
                "230": "Compositor",
                "240": "Compositor gráfico",
                "245": "Ideia original de (usado para audiovisual)",
                "250": "Maestro",
                "260": "Detentor dos direitos de autor",
                "270": "Corrector",
                "273": "Organizador de exposição",
                "275": "Bailarino",
                "280": "Personalidade a quem é dedicada a obra",
                "290": "Autor da dedicatória",
                "300": "Director",
                "305": "Dissertador",
                "310": "Distribuidor",
                "320": "Doador",
                ...
                "350": "Gravador (burilista)",
                "360": "Gravador (aguafortista)",
                "365": "Perito",
                "370": "Editor de filmes",
                "380": "Contrafactor",
                "390": "Antigo possuidor",
                "410": "Técnico gráfico",
                "420": "Em memória/honra de",
                "430": "Iluminista",
                "440": "Ilustrador",
                "445": "Empresário (teatral/musical)",
                "450": "Autor da apresentação",
                "460": "Entrevistado",
                "470": "Entrevistador",
                "480": "Libretista",
                "490": "Personalidade que detém licença",
                "500": "Pessoa que concede licença",
                "510": "Litógrafo",
                "520": "Autor de letras para trechos musicais",
                "530": "Gravador em metal",
                "540": "Supervisor",
                "545": "Músico",
                "550": "Narrador",
                "555": "Arguente",
                "557": "Organizador de conferência",
                "560": "Investigador",
                "570": "Outro",
                ...
                "600": "Fotógrafo",
                "610": "Impressor",
                "620": "Impressor de ilustração em chapa gravada",
                "630": "Produtor",
                "632": "Director artístico",
                "633": "Equipa de produção",
                "640": "Revisor",
                "650": "Editor comercial",
                "660": "Destinatário de carta(s)",
                ...
                "705": "Escultor",
                "710": "Relator",
                "720": "Autor de assinatura manuscrita",
                "721": "Cantor",
                "723": "Patrocinador",
                "727": "Orientador de tese",
                "730": "Tradutor",
                "740": "Responsável pela concepção do tipo",
                "750": "Tipógrafo",
                "755": "Entretainer",
        ...
        function codigoFuncaoAutorizado(codigo) {
            ...
            if (!codigo) return true; // ausência de código não é o mesmo que código inválido
...
function renderAreaIntervencao() {
            ...
            html += '</div>';
            html += '<span class="kore-operational-badge">' + valorOuPorAnalisar(countByFiltroOperacional("todos")) + ' ocorrência(s)</span>';
            html += '</div>';
        ...
        function aplicarNoCampo017(valor, fonte) {
            ...
            if (!escolhido) {
                $("#kore-estado").text("Não existe campo 017 livre. Adicione um novo campo 017 vazio e volte a aplicar.");
                return;
            }

            if (escolhido.indicador1.length) {
                escolhido.indicador1.val("7").trigger("input").trigger("change");
            }
            ...
            $("#kore-estado").html(
                'Aplicado no 017: indicador 1 = 7, 017$a = <strong>' +
                escaparHTML(valor) +
                '</strong>, 017$2 = <strong>' +
                escaparHTML(fonte) +
                '</strong>.'
        ...
        function atualizarProgressoDashboard(atual, total, mensagem) {
            ...
            $("#kore-dashboard-progresslabel").text(total ? ("Registos processados: " + atual + " / " + total + " (" + percentagem + "%)") : "Registos processados: 0 / 0 (0%)");
        }
        ...
        function ocultarProgressoDashboard() {
            ...
            $("#kore-dashboard-progresslabel").text("Registos processados: 0 / 0 (0%)");
...
function analisarBlocoAutoria(bloco, authid, nomeNorm, obra) {
            ...
            var codigosValidos4 = codigos4.filter(function (c) { return codigoFuncaoAutorizado(c); });
            var codigosInvalidos4 = codigos4.filter(function (c) { return !codigoFuncaoAutorizado(c); });
            var exigeFuncao4 = bloco.campo !== "700"; // 700 = responsabilidade principal; $4 não é exigível aqui
            var tem4 = exigeFuncao4 ? (codigosValidos4.length > 0) : true;
            var valorDecisao = valorAutoria || bloco.texto;

            if (codigosInvalidos4.length) {
                return criarOcorrencia({
                    obra: obra,
                    campo: bloco.campo + "$4",
                    natureza: "Código de função inválido",
                    valorEncontrado: (valorDecisao || ("Autoridade " + authid)) + " || $4: " + codigosInvalidos4.join(", "),
                    problema: "Código $4 não autorizado",
                    prioridade: "Revisão",
                    authidEsperado: authid,
                    ...
                    acaoDetalhada: "O subcampo $4 contém o(s) código(s) " + codigosInvalidos4.join(", ") + ", que não constam da lista de valores autorizados CODIGOFUNC desta instituição. Substituir por um código válido ou remover o valor incorrecto.",
                    grupo: "imediata"
                });
            }
        ...
        if (imagem && !primeiraImagem) primeiraImagem = imagem;
                ...
                html += '<button type="button" class="kore-aplicar-017" data-valor="' + escaparHTML(qid) + '" data-fonte="wikidata">Wikidata</button>';
                html += '</div>';
    ...
    renderDashboard();
            ...
            $.ajax({
                ...
                success: function (dados) {
                    ...
                    $.each(dados.result.slice(0, CONFIG.maxResultadosVIAF), function (i, item) {
                        ...
                        html += '<button type="button" class="kore-aplicar-017" data-valor="' + escaparHTML(viafid) + '" data-fonte="viaf">VIAF</button>';
                        html += '</div>';
                        html += '</div>';
                    });
        ...
        function koreV6InstalarCamadaUX() {
            var css = "";
            css += '<style id="kore-v6-authority-intelligence-css">';
            css += '#kore-identidade{border:1px solid #d9e2ec!important;border-radius:12px!important;box-shadow:0 10px 28px rgba(15,23,42,.07)!important;background:#ffffff!important;overflow:hidden!important;}';
            css += '#kore-identidade .kore-header{background:linear-gradient(135deg,#ffffff 0%,#f8fbfd 100%)!important;border-bottom:1px solid #e6edf3!important;}';
            css += '#kore-identidade .kore-tab{border-radius:999px!important;padding:7px 12px!important;font-weight:700!important;}';
            css += '#kore-identidade .kore-tab-ativa{background:#eef8fb!important;color:#006f8f!important;border-color:#9bd3e0!important;}';
            css += '#kore-identidade .kore-v34-problems{background:#fff!important;border:1px solid #dbe5ee!important;border-radius:12px!important;overflow:hidden!important;box-shadow:0 6px 18px rgba(15,23,42,.045)!important;}';
            css += '#kore-identidade .kore-operational-head{padding:14px 16px!important;background:linear-gradient(135deg,#ffffff 0%,#f9fbfc 100%)!important;border-bottom:1px solid #e7edf3!important;}';
            css += '#kore-identidade .kore-operational-head h3{font-size:17px!important;font-weight:850!important;letter-spacing:-.01em!important;}';
            css += '#kore-identidade .kore-operational-head p{font-size:12px!important;color:#64748b!important;}';
            css += '#kore-identidade .kore-operational-badge{display:inline-flex!important;align-items:center!important;border-radius:999px!important;background:#f1f5f9!important;border:1px solid #dbe5ee!important;color:#334155!important;padding:5px 10px!important;font-size:12px!important;font-weight:750!important;}';
            css += '#kore-identidade .kore-problem-menu{display:grid!important;grid-template-columns:repeat(7,minmax(118px,1fr))!important;gap:8px!important;padding:12px!important;background:#ffffff!important;border-bottom:1px solid #e7edf3!important;}';
            css += '@media(max-width:1450px){#kore-identidade .kore-problem-menu{grid-template-columns:repeat(4,minmax(120px,1fr))!important;}}';
            css += '@media(max-width:900px){#kore-identidade .kore-problem-menu{grid-template-columns:repeat(2,minmax(120px,1fr))!important;}}';
            css += '@media(max-width:560px){#kore-identidade .kore-problem-menu{grid-template-columns:1fr!important;}}';
            css += '#kore-identidade .kore-problem-menu button{display:flex!important;justify-content:space-between!important;align-items:center!important;gap:10px!important;width:100%!important;min-height:44px!important;padding:8px 10px!important;border-radius:10px!important;border:1px solid #dbe5ee!important;background:#fff!important;box-shadow:0 1px 2px rgba(15,23,42,.035)!important;text-align:left!important;font-weight:600!important;}';
            css += '#kore-identidade .kore-problem-menu button:hover{transform:translateY(-1px)!important;box-shadow:0 5px 14px rgba(15,23,42,.06)!important;border-color:#a8bdcf!important;}';
            css += '#kore-identidade .kore-problem-menu button.kore-filtro-ativo{background:#f0f9ff!important;border-color:#38a8c7!important;color:#075985!important;box-shadow:0 0 0 3px rgba(0,127,174,.08)!important;}';
            css += '#kore-identidade .kore-menu-label{display:block!important;min-width:0!important;white-space:normal!important;line-height:1.15!important;font-size:12px!important;font-weight:650!important;color:#1e293b!important;}';
            css += '#kore-identidade .kore-problem-count{display:inline-flex!important;align-items:center!important;justify-content:center!important;min-width:28px!important;height:24px!important;padding:0 8px!important;border-radius:999px!important;background:#f1f5f9!important;color:#0f172a!important;font-size:12px!important;font-weight:850!important;margin:0!important;}';
            css += '#kore-identidade .kore-menu-ok{border-left:4px solid #12b76a!important;}';
            css += '#kore-identidade .kore-menu-neutral{border-left:4px solid #64748b!important;}';
            css += '#kore-identidade .kore-menu-critical{border-left:4px solid #e11d48!important;}';
            css += '#kore-identidade .kore-menu-review{border-left:4px solid #f59e0b!important;}';
            css += '#kore-identidade .kore-menu-context{border-left:4px solid #0284c7!important;}';
            css += '#kore-identidade .kore-v6-cardrow td{background:#fff!important;}';
            css += '#kore-identidade .kore-v6-occ-card{border:1px solid #e2e8f0;border-radius:10px;background:#ffffff;padding:10px 11px;box-shadow:0 1px 2px rgba(15,23,42,.03);}';
            css += '#kore-identidade .kore-v6-occ-top{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:6px;}';
            css += '#kore-identidade .kore-v6-occ-title{font-weight:800;color:#0f172a;font-size:13px;line-height:1.25;}';
            css += '#kore-identidade .kore-v6-occ-meta{font-size:11px;color:#64748b;margin-top:2px;line-height:1.3;}';
            css += '#kore-identidade .kore-v6-badge{display:inline-flex;align-items:center;border-radius:999px;padding:3px 8px;font-size:10px;font-weight:850;white-space:nowrap;border:1px solid transparent;}';
            css += '#kore-identidade .kore-v6-badge-ok{background:#ecfdf3;color:#047857;border-color:#bbf7d0;}';
            css += '#kore-identidade .kore-v6-badge-critical{background:#fff1f2;color:#be123c;border-color:#fecdd3;}';
            css += '#kore-identidade .kore-v6-badge-review{background:#fffbeb;color:#b45309;border-color:#fde68a;}';
            css += '#kore-identidade .kore-v6-badge-info{background:#eff6ff;color:#1d4ed8;border-color:#bfdbfe;}';
            css += '#kore-identidade .kore-v6-semantic{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px;margin-top:8px;}';
            css += '@media(max-width:900px){#kore-identidade .kore-v6-semantic{grid-template-columns:1fr;}}';
            css += '#kore-identidade .kore-v6-semantic div{border:1px solid #edf2f7;background:#f8fafc;border-radius:8px;padding:6px 8px;font-size:11px;line-height:1.35;color:#334155;}';
            css += '#kore-identidade .kore-v6-semantic strong{display:block;color:#0f172a;font-size:10px;text-transform:uppercase;letter-spacing:.03em;margin-bottom:2px;}';
            css += '#kore-identidade .kore-v6-action{font-weight:800;color:#0f172a;}';
            css += '#kore-identidade .kore-v6-action small{display:block;font-weight:500;color:#64748b;line-height:1.35;margin-top:3px;}';
            css += '#kore-identidade .kore-table th{background:#f8fafc!important;color:#334155!important;font-size:10px!important;letter-spacing:.045em!important;padding:9px 8px!important;}';
            css += '#kore-identidade .kore-table td{padding:9px 8px!important;}';
            css += '#kore-identidade .kore-table td.kore-title-cell{min-width:280px!important;}';
            css += '#kore-identidade .kore-table-links a{border-radius:8px!important;min-width:30px!important;text-align:center!important;}';
            css += '#kore-identidade .kore-link-icon.fa-pencil:before{content:"✎";font-family:Arial,sans-serif!important;font-weight:800;}';
            css += '#kore-identidade .kore-link-icon.fa-file-text-o:before{content:"□";font-family:Arial,sans-serif!important;font-weight:800;}';
            css += '#kore-identidade .kore-link-icon.fa-globe:before{content:"◎";font-family:Arial,sans-serif!important;font-weight:800;}';
            css += '#kore-identidade .kore-v6-rever-box{border-left-color:#f59e0b!important;}';
            css += '#kore-identidade .kore-v6-semantic-note{display:block;margin-top:5px;color:#475569;font-size:11px;line-height:1.35;}';
            css += '#kore-identidade .kore-vazio{font-style:normal!important;color:#64748b!important;background:#f8fafc!important;border-radius:8px!important;}';

            css += '#kore-identidade .kore-source-tabs{display:flex!important;gap:10px!important;align-items:center!important;flex-wrap:wrap!important;}';
            css += '#kore-identidade .kore-source-card{display:inline-flex!important;align-items:center!important;gap:10px!important;min-height:46px!important;border-radius:14px!important;padding:9px 14px!important;background:#fff!important;border:1px solid #dbe5ee!important;box-shadow:0 3px 10px rgba(15,23,42,.045)!important;}';
            css += '#kore-identidade .kore-logo-dashboard{width:32px;height:32px;border-radius:999px;background:#eef8fb;display:inline-flex;align-items:center;justify-content:center;color:#007fae;}';
            css += '#kore-identidade .kore-logo-dashboard svg{width:22px;height:22px;fill:currentColor;}';
            css += '#kore-identidade .kore-source-open{display:inline-flex!important;align-items:center!important;gap:8px!important;min-height:36px!important;border-radius:10px!important;}';
            css += '#kore-identidade .kore-source-open .kore-logo-wikidata svg{width:104px;height:28px;}';
            css += '#kore-identidade .kore-source-open .kore-logo-viaf svg{width:72px;height:28px;}';
            css += '#kore-identidade .kore-source-panel{border-radius:14px!important;border-color:#dbe5ee!important;box-shadow:0 6px 18px rgba(15,23,42,.045)!important;}';
            css += '#kore-identidade .kore-source-panel h3{display:flex!important;align-items:center!important;margin-bottom:12px!important;}';
            css += '#kore-identidade .kore-source-panel h3 .kore-logo-wikidata svg{width:126px;height:34px;}';
            css += '#kore-identidade .kore-source-panel h3 .kore-logo-viaf svg{width:88px;height:34px;}';
            css += '#kore-identidade .kore-dashboard-controlbar{display:grid!important;grid-template-columns:auto minmax(220px,1fr) auto!important;align-items:center!important;gap:12px!important;border-radius:14px!important;background:#fff!important;border:1px solid #dbe5ee!important;box-shadow:0 4px 14px rgba(15,23,42,.04)!important;padding:10px 12px!important;}';
            css += '#kore-identidade .kore-dashboard-progress{display:block!important;border:0!important;background:transparent!important;padding:0!important;margin:0!important;min-width:220px!important;}';
            css += '#kore-identidade .kore-dashboard-progress.kore-fechado{display:block!important;opacity:.42!important;}';
            css += '#kore-identidade .kore-dashboard-progressbar{height:9px!important;background:#edf2f7!important;border-radius:999px!important;overflow:hidden!important;}';
            css += '#kore-identidade .kore-dashboard-progressbar span{background:linear-gradient(90deg,#8fd3e8,#0080a3)!important;border-radius:999px!important;}';
            css += '#kore-identidade .kore-dashboard-progresslabel{margin:0!important;white-space:nowrap!important;font-size:12px!important;color:#475569!important;font-weight:650!important;text-align:right!important;}';
            css += '#kore-identidade .kore-problem-menu{grid-template-columns:repeat(6,minmax(130px,1fr))!important;}';
            css += '#kore-identidade .kore-problem-menu button{min-height:38px!important;border-left-width:3px!important;border-radius:9px!important;box-shadow:none!important;}';
            css += '#kore-identidade .kore-problem-menu button.kore-filtro-ativo{background:#f8fbfd!important;border-color:#7da2c8!important;box-shadow:inset 0 0 0 1px rgba(0,127,174,.18)!important;}';
            css += '#kore-identidade .kore-v6-occ-lines{display:grid;gap:4px;margin-top:7px;}';
            css += '#kore-identidade .kore-v6-line{display:grid;grid-template-columns:52px 1fr;gap:7px;align-items:start;border:1px solid #edf2f7;background:#fbfdff;border-radius:8px;padding:5px 7px;font-size:11px;line-height:1.35;color:#334155;}';
            css += '#kore-identidade .kore-v6-line-label{font-weight:850;color:#0f172a;font-size:10px;text-transform:uppercase;letter-spacing:.03em;}';
            css += '#kore-identidade .kore-v6-line-200{background:#f8fafc;}';
            css += '#kore-identidade .kore-v6-line-7xx{background:#f9fbff;}';
            css += '#kore-identidade .kore-v6-line-400{background:#f7fdf9;}';
            css += '#kore-identidade .kore-v6-line-500{background:#fffaf2;}';
            css += '#kore-identidade .kore-v6-technical{margin-top:7px;border-top:1px solid #edf2f7;padding-top:6px;}';
            css += '#kore-identidade .kore-v6-technical summary{cursor:pointer;font-size:11px;color:#64748b;font-weight:700;}';
            css += '#kore-identidade .kore-v6-technical pre{white-space:pre-wrap;margin:6px 0 0 0;background:#f8fafc;border:1px solid #edf2f7;border-radius:8px;padding:7px;font-size:11px;color:#475569;font-family:Consolas,monospace;}';
            css += '#kore-identidade .kore-v6-semantic{grid-template-columns:repeat(5,minmax(0,1fr))!important;}';
            css += '@media(max-width:1150px){#kore-identidade .kore-v6-semantic{grid-template-columns:repeat(2,minmax(0,1fr))!important;}}';
            css += '#kore-identidade .kore-v34-main,#kore-identidade .kore-v34-top{grid-template-columns:minmax(420px,.95fr) minmax(620px,1.55fr)!important;}';
            css += '</style>';

            if (!$("#kore-v6-authority-intelligence-css").length) $("head").append(css);
        }
        ...
        function koreV6FormatarAcao(o) {
            var acao = formatarAcaoTabela(o);
            var sem = koreV6ClassificacaoSemantica(o);
            var titulo = acao.titulo || "Analisar";
            var detalhe = acao.detalhe || sem.detalhe;

            if (koreV6EhOutroAutor(o)) {
                titulo = "Confirmar entidade";
                detalhe = "Validar se o authid encontrado corresponde a outro autor, a um duplicado ou a uma relação 500. Não substituir automaticamente.";
            } else if (koreV6EhResponsabilidade(o)) {
                if (koreV6Compatibilidade200(o)) {
                    titulo = "Confirmar coerência";
                    detalhe = "A menção 200$f parece compatível com a forma autorizada, variante 400 ou relação 500. Sem intervenção automática; confirmar apenas se o ponto 7xx está coerente.";
                } else {
                    titulo = "Avaliar entidade ou variante";
                    detalhe = "Não foi encontrada compatibilidade suficiente com 200/400/500. Confirmar se falta variante 400, ponto 7xx ou se há outra entidade.";
                }
            } else if (koreV6EhLigado(o)) {
                titulo = "Manter";
                detalhe = "Ligação estrutural presente e compatível com a autoridade esperada.";
            }
        ...
        function textoAutoriaCompativel(texto, nomeNorm) {
            ...
            for (var i = 0; i < universo.length; i++) {
                ...
                if (partesU.length <= 1) {
                    // Forma de uma só palavra (heterónimo ou pseudónimo de nome único):
                    // exige palavra inteira, nunca substring, para não confundir com
                    // fragmentos de outras palavras ou nomes de terceiros.
                ...
                for (var j = 0; j < partesU.length; j++) {
                    if (contemPalavraInteira(t, partesU[j])) encontrados++;
                }
