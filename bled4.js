/* ==========================================
   ...
   - apresenta o número de edições encontradas;
   - soma os empréstimos digitais disponíveis;
   - abre a pesquisa pública por título e autor;
...
(function () {
  ...
  /*
   * Não filtra pela função do colaborador.
   *
   * A API pode devolver designações diferentes
   * em contributor.nature.
   */
