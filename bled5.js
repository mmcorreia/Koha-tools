/* ==========================================
   ...
   - apresenta o número de edições;
   - soma licenças disponíveis;
   - soma reservas ativas;
   - apresenta o total de licenças;
   - apresenta a próxima devolução prevista;
   - abre a pesquisa pública filtrada por título e autor;
   - só mostra o botão quando encontra uma correspondência.
   ========================================== */
